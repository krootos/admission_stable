...
!(function (a, b) {
  ...
  function h() {
    this.element.trigger("initialize" + C),
      k.call(this),
      ...
      o.call(this),
      l.call(this),
      this.element.trigger("initialized" + C);
  }
  function i() {
  ...
  function k() {
    ...
    c.children().each(function () {
      ...
      b.columns.push(f),
        null != f.order && (b.sort[f.id] = f.order),
  ...
  function l() {
    function c(a) {
      for (
        var b,
          c = new RegExp(f.searchPhrase, f.options.caseSensitive ? "g" : "gi"),
          d = 0;
        d < f.columns.length;
        d++
      )
    ...
    function d(a, b) {
      (f.currentRows = a),
        (f.total = b),
        (f.totalPages = Math.ceil(b / f.rowCount)),
        f.options.keepSelection || (f.selectedRows = []),
        v.call(f, a),
        q.call(f),
        s.call(f),
        f.element._bgBusyAria(!1).trigger("loaded" + C);
    }
    var f = this,
      h = e.call(this),
      i = g.call(this);
    if (
      this.options.ajax &&
      (null == i || "string" != typeof i || 0 === i.length)
    )
      throw new Error(
        "Url setting must be a none empty string or a function that returns one."
      );
    if (
      (this.element._bgBusyAria(!0).trigger("load" + C),
      A.call(this),
      this.options.ajax)
    )
      f.xqr && f.xqr.abort(),
        (f.xqr = a
          ...
          .fail(function (a, b) {
            (f.xqr = null),
              "abort" !== b &&
                (r.call(f), f.element._bgBusyAria(!1).trigger("loaded" + C));
          }));
    else {
      var j = this.searchPhrase.length > 0 ? this.rows.where(c) : this.rows,
        k = j.length;
      -1 !== this.rowCount && (j = j.page(this.current, this.rowCount)),
  ...
  function n() {
    ...
    this.element.addClass(this.options.css.table),
      ...
      1 & this.options.navigation &&
        ((this.header = a(
          b.header.resolve(
            d.call(this, { id: this.element._bgId() + "-header" })
          )
        )),
      ...
      2 & this.options.navigation &&
        ((this.footer = a(
          b.footer.resolve(
            d.call(this, { id: this.element._bgId() + "-footer" })
          )
        )),
        c.after(this.footer));
  }
  function o() {
    if (0 !== this.options.navigation) {
      ...
      if (e.length + g.length > 0) {
        ...
        if (this.options.ajax) {
          var k = i.icon.resolve(d.call(this, { iconCss: b.iconRefresh })),
            m = a(
              i.actionButton.resolve(
                d.call(this, { content: k, text: this.options.labels.refresh })
              )
  ...
  function p(b) {
    if (this.options.columnSelection && this.columns.length > 1) {
      var c = this,
        ...
        h = g.icon.resolve(d.call(this, { iconCss: e.iconColumns })),
        i = a(g.actionDropDown.resolve(d.call(this, { content: h }))),
        k = f(e.dropDownItem),
        m = f(e.dropDownItemCheckbox),
        n = f(e.dropDownMenuItems);
      a.each(this.columns, function (b, h) {
        var o = a(
          g.actionDropDownCheckboxItem.resolve(
            d.call(c, { name: h.id, label: h.text, checked: h.visible })
          )
  ...
  function r() {
    ...
    this.selection && (c += 1),
      a.html(b.noResults.resolve(d.call(this, { columns: c })));
  }
  function s() {
    if (0 !== this.options.navigation) {
      ...
      if (-1 !== this.rowCount && c.length + e.length > 0) {
        var g = this.options.templates,
          ...
          o = i >= n ? n : i;
        t.call(this, j, "first", "&laquo;", "first")._bgEnableAria(h > 1),
          t.call(this, j, "prev", "&lt;", "prev")._bgEnableAria(h > 1);
        for (var p = 0; o > p; p++) {
          var q = p + m;
          t.call(this, j, q, q, "page-" + q)
            ._bgEnableAria()
            ._bgSelectAria(q === h);
        }
        0 === o &&
          t.call(this, j, 1, 1, "page-1")._bgEnableAria(!1)._bgSelectAria(),
          t.call(this, j, "next", "&gt;", "next")._bgEnableAria(i > h),
          t.call(this, j, "last", "&raquo;", "last")._bgEnableAria(i > h),
          z.call(this, c, j, 1),
          z.call(this, e, j, 2);
      }
    }
  ...
  function t(b, c, e, g) {
    var h = this,
      i = this.options.templates,
      j = this.options.css,
      k = d.call(this, { css: g, text: e, uri: "#" + c }),
      m = a(i.paginationItem.resolve(k)).on(
        "click" + C,
        f(j.paginationButton),
        function (b) {
          b.stopPropagation();
          var c = a(this),
            d = c.parent();
  ...
  function u(b) {
    ...
    if (a.isArray(g)) {
      var h = this.options.css,
        i = this.options.templates,
        j = a(
          i.actionDropDown.resolve(d.call(this, { content: this.rowCount }))
        ),
        k = f(h.dropDownMenu),
      ...
      a.each(g, function (b, f) {
        var g = a(
          i.actionDropDownItem.resolve(d.call(e, { text: c(f), uri: "#" + f }))
        )
          ._bgSelectAria(f === e.rowCount)
          .on("click" + C, o, function (b) {
            b.preventDefault();
            var d = a(this),
    ...
    if (b.length > 0) {
      ...
      a.each(b, function (b, f) {
        if (
          ...
          (l =
            ' data-row-id="' +
            (null == c.identifier ? b : f[c.identifier]) +
            '"'),
          (m = ""),
          c.selection)
        ) {
          ...
          (k += g.cell.resolve(d.call(c, { content: n, css: e.selectCell }))),
            (i = i && h),
            h && ((m += e.selected), (l += ' aria-selected="true"'));
        }
        a.each(c.columns, function (b, h) {
          if (h.visible) {
            var i = a.isFunction(h.formatter)
                ? h.formatter.call(c, h, f)
                : h.converter.to(f[h.id]),
          ...
          m.length > 0 && (l += ' class="' + m + '"'),
          (j += g.row.resolve(d.call(c, { attr: l, cells: k })));
      }),
        c.element
          .find("thead " + f(c.options.css.selectBox))
          .prop("checked", i),
        h.html(j),
        w.call(this, h);
    } else r.call(this);
  ...
  function w(b) {
    ...
    this.selection &&
      b.off("click" + C, d).on("click" + C, d, function (b) {
        b.stopPropagation();
        var d = a(this),
      ...
      b.off("click" + C, "> tr").on("click" + C, "> tr", function (b) {
        ...
        c.selection &&
          ...
          (d.hasClass(c.options.css.selected)
            ? c.deselect([e])
            : c.select([e])),
          c.element.trigger("click" + C, [c.columns, f]);
      });
  }
  function x() {
    if (0 !== this.options.navigation) {
  ...
  function y() {
    ...
    if (this.selection) {
      var j = this.options.multiSelect
        ? g.select.resolve(d.call(b, { type: "checkbox", value: "all" }))
        : "";
      h += g.rawHeaderCell.resolve(
        d.call(b, { content: j, css: e.selectCell })
      );
    }
    if (
          ...
          var f = b.sort[c.id],
            j =
              i && f && "asc" === f
                ...
                ? e.iconDown
                : "",
            k = g.icon.resolve(d.call(b, { iconCss: j })),
            l = c.headerAlign,
            m = c.headerCssClass.length > 0 ? " " + c.headerCssClass : "";
          h += g.headerCell.resolve(
            d.call(b, {
              column: c,
              icon: k,
              sortable: (i && c.sortable && e.sortable) || "",
              css:
                ("right" === l ? e.right : "center" === l ? e.center : e.left) +
                m,
            })
          );
        }
      ...
      c.off("click" + C, k).on("click" + C, k, function (c) {
        ...
        if (
          ...
          (b.sort[f] = "desc"), h.removeClass(e.iconUp).addClass(e.iconDown);
        else if (g && "desc" === g)
          if (b.options.multiSort) {
            ...
            (b.sort[f] = "asc"), h.removeClass(e.iconDown).addClass(e.iconUp);
  ...
  function A() {
    ...
    this.selection && (g += 1),
      c.html(a.loading.resolve(d.call(this, { columns: g }))),
      -1 !== this.rowCount &&
        f > 0 &&
        c.find("tr > td").css("padding", "20px 0 " + f + "px");
  }
  function B() {
    function a(c, d, e) {
      function f(a) {
  ...
  var C = ".rs.jquery.bootgrid",
    D = function (b, c) {
      (this.element = a(b)),
        ...
        (this.options = a.extend(!0, {}, D.defaults, this.element.data(), c));
  ...
  if (
    ((D.defaults = {
      ...
      templates: {
        ...
        headerCell:
          '<th data-column-id="{{ctx.column.id}}" class="{{ctx.css}}"><a href="javascript:void(0);" class="{{css.columnHeaderAnchor}} {{ctx.sortable}}"><span class="{{css.columnHeaderText}}">{{ctx.column.text}}</span>{{ctx.icon}}</a></th>',
        ...
        paginationItem:
          '<li class="{{ctx.css}}"><a href="{{ctx.uri}}" class="{{css.paginationButton}}">{{ctx.text}}</a></li>',
        rawHeaderCell: '<th class="{{ctx.css}}">{{ctx.content}}</th>',
        row: "<tr{{ctx.attr}}>{{ctx.cells}}</tr>",
        search:
          '<div class="{{css.search}}"><div class="input-group"><span class="{{css.icon}} input-group-addon glyphicon-search"></span> <input type="text" class="{{css.searchField}}" placeholder="{{lbl.search}}" /></div></div>',
        select:
    ...
    (D.prototype.append = function (a) {
      if (this.options.ajax);
        ...
        for (var b = [], d = 0; d < a.length; d++)
          c.call(this, a[d]) && b.push(a[d]);
        B.call(this),
          i.call(this, b),
          l.call(this),
          this.element.trigger("appended" + C, [b]);
      }
      return this;
    }),
    (D.prototype.clear = function () {
      if (this.options.ajax);
        ...
        (this.rows = []),
          ...
          (this.total = 0),
          l.call(this),
          this.element.trigger("cleared" + C, [b]);
      }
      return this;
    }),
    ...
    (D.prototype.remove = function (a) {
      if (null != this.identifier) {
        if (this.options.ajax);
          ...
          (this.current = 1),
            l.call(this),
            this.element.trigger("removed" + C, [c]);
        }
      }
      return this;
    }),
    (D.prototype.search = function (a) {
      return (
        this.searchPhrase !== a &&
          ((this.current = 1), (this.searchPhrase = a), l.call(this)),
        this
      );
    }),
    (D.prototype.select = function (b) {
      if (this.selection) {
        ...
        if (e.length > 0) {
          ...
          for (
            d = 0;
            !this.options.keepSelection && h && d < this.currentRows.length;
          ...
          for (
            this.element.find("thead " + g).prop("checked", h),
              this.options.multiSelect ||
                this.element
                  .find("tbody > tr " + g + ":checked")
                  .trigger("click" + C),
              d = 0;
    ...
    (D.prototype.deselect = function (b) {
      if (this.selection) {
        ...
        if (g.length > 0) {
          ...
          for (
            this.element.find("thead " + h).prop("checked", !1), d = 0;
            d < g.length;
            d++
          )
            this.element
              .find('tbody > tr[data-row-id="' + g[d][this.identifier] + '"]')
    ...
    (D.prototype.sort = function (b) {
      ...
      return c === this.sort
        ? this
        : ((this.sort = c), y.call(this), B.call(this), l.call(this), this);
    }),
    a.fn.extend({
        ...
        a.each(b, function (b, e) {
          if (null != e && "function" != typeof e)
            if ("object" == typeof e) {
              ...
              E && E[b] && "function" == typeof E[b] && (e = E[b](e)),
                (b = c ? c.join(".") + "." + b : b);
  ...
  (a.fn.bootgrid = function (b) {
    ...
    return this.each(function () {
      ...
      if (e || "destroy" !== b)
        return (
          e || (d.data(C, (e = new D(this, f))), h.call(e)),
          "string" == typeof b ? e[b].apply(e, c) : void 0
        );
    });
  }),
    (a.fn.bootgrid.Constructor = D),
