    ...
    <!--div class="form-group form-group-lg">
            ...
            <div >           
                ...
                <label class=" col-sm-10 control-label" style="color: #23527c;">  
                   <h4> <span style="color: #b51515;">*หมายเหตุ แผนการเรียนวิทยาศาสตร์-คณิตศาสตร์ เกรดเฉลี่ย 2.50 ขึ้นไป</span> </h4> 
                </label> 
            ...
            <div class="form-group">
                <div class="col-sm-offset-8 col-sm-12 text-center">
                    <button style="background-color:#fa9d00; color:#ffffff;" class="btn btn-lg btn-block" name="btnNext5" 
...
?>
         ...
         <div class="form-group form-group-lg">
            <label class="col-sm-12 control-label" for="formGroupInputLarge" style="color: #666464;">
                อันดับที่ 2 :
            </label>
            <!--label for="inputEmail3" class="col-sm-2 control-label">เลขที่ใบสมัคร</label-->
            <div class="col-sm-12">
...
<?php if(isset($_SESSION["EDITE"])){ if($_SESSION["EDITE"][58] == "ภาษาญี่ปุ่น"){  echo"selected"; }}?>
        ...
        <?php if(!isset($_GET["edite"])){ ?>
                ...
                <button class="btn btn-primary btn-lg btn-block" name="btnNext5" 
        ...
        <?php }else{ ?>
                ...
                <button class="btn btn-primary btn-lg btn-block" name="btnEdite5" 
                type="submit" value="Login" 
