        ...
        <div class="row">
            <div class="col-md-12">
                <div class="pull-right">
                    <button class="btn btn-success" data-toggle="modal" data-target="#add_new_record_modal">Add New
                        User</button>
                </div>
            </div>
                        ...
                        <table class="table table-bordered table-striped">
                            <tr>
                                <td width="36%">
                                    <div align="right">ค้นหา :
                                        <select name="cat" class="input-sm">
                                            <option value="RegisNO"
                                                <?php if(isset($_REQUEST["cat"])){ if($_REQUEST["cat"] == "RegisNO"){  echo"selected"; }} ?>>
                                                รหัสผู้ใช้งาน</option>
                                            <option value="RegisPWD"
                                                <?php if(isset($_REQUEST["cat"])){ if($_REQUEST["cat"] == "RegisPWD"){  echo"selected"; }} ?>>
                                                รหัสผ่าน</option>
                                            <option value="RegisNaID"
                                                <?php if(isset($_REQUEST["cat"])){ if($_REQUEST["cat"] == "RegisNaID"){  echo"selected"; }} ?>>
                                                เลขบัตรประชาชน</option>
                                            <option value="OPTIONS"
                                                <?php if(isset($_REQUEST["cat"])){ if($_REQUEST["cat"] == "OPTIONS"){  echo"selected"; }} ?>>
                                                ประเภทนักเรียน</option>
                                            <option value="TYPE"
                                                <?php if(isset($_REQUEST["cat"])){ if($_REQUEST["cat"] == "TYPE"){  echo"selected"; }} ?>>
                                                ระดับชั้น</option>
                                        </select>
                                    </div>
                                </td>
                                <td width="64%">
                                    ...
                                    <button class="btn btn-info" name="btnSearch" id="btnSearch" type="submit"
                                        value="btnSearch">Search</button>
                                    ตามรหัสผู้ใช้งาน, รหัสผ่าน, เลขบัตรประชาชน
                                    <a class="btn btn-default" <?php if(isset($_SESSION["cat"])){ echo "href=\"index.php?btnAll=yes\""; }else{
        echo "href=\"\"";
      }
       ?>>ทั้งหมด</a>
                                    ...
                                    <a class="btn btn-default" href="index.php?le=1&req=ok"> ม.1 ท้งหมด</a>
                                    <a class="btn btn-default" href="index.php?le=2&req=ok"> ม.1 ในเขตฯ</a>
                                    <a class="btn btn-default" href="index.php?le=3&req=ok"> ม.1 นอกเขตฯ</a>


                                    <a class="btn btn-default" href="index.php?le=4&req=ok"> ม.4 ท้งหมด</a>
                                    <a class="btn btn-default" href="index.php?le=5&req=ok"> ม.4 วิทย์ฯ-คณิตฯ </a>
                                    <a class="btn btn-default" href="index.php?le=6&req=ok"> ม.4 วิทย์ฯ-คอมฯ </a>
                                    <a class="btn btn-default" href="index.php?le=7&req=ok"> ม.4 อังกฤษ-จีน</a>
                                    <a class="btn btn-default" href="index.php?le=8&req=ok"> ม.4 อังกฤษ-ญี่ปุ่น</a>
                                    <a class="btn btn-default" href="index.php?le=9&req=ok"> ม.4 อังกฤษ-เวียดนาม</a>
                                    <a class="btn btn-default" href="index.php?le=10&req=ok"> ม.4 อังกฤษ-เกาหลี</a>
                                    <a class="btn btn-default" href="index.php?le=11&req=ok"> ม.4 ไทย-สังคม</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="update_regisnewnaid" maxlength="13" placeholder="จำนวน 13 หลัก"
                            class="form-control" />
                    </div>
