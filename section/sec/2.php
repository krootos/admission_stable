            ...
            <div class="col-sm-9">
                ...
                <select class="form-control input-lg" name="lbSname" required="">
                 ...
                 <option value="เด็กชาย"
                  <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][8] == "เด็กชาย") {echo "selected";}}?>>เด็กชาย
                  </option>

                 <option value="เด็กหญิง"
                 <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][8] == "เด็กหญิง") {echo "selected";}}?>>เด็กหญิง
                 </option>
                 <option value="นาย"
                 <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][8] == "นาย") {echo "selected";}}?>>นาย
                 </option>
                 <option value="นางสาว"
                 <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][8] == "นางสาว") {echo "selected";}}?>>นางสาว
                 </option>
                </select>
            </div>
        </div>
...
if (isset($_SESSION["EDITE"])) {?>
                         value="<?php echo $_SESSION["EDITE"][11]; ?>"
                <?php
} else {
    if (isset($_SESSION['SAS1'][1]) && ($_SESSION['SAS1'][1] == 1)) {
        echo "value=\"01/01/2550\"";} else {echo "value=\"01/01/2546\"";}}?>
                >
            </div>
        ...
        <div class="form-group form-group-lg">
            ...
            <div class="col-sm-3">
                <select class="form-control input-lg" name="lbSex" required="">
                 <option value="">-- กรุณาเลือก --</option>
                 <option value="ชาย"
          <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][12] == "ชาย") {echo "selected";}}?>
                 >ชาย</option>
                 <option value="หญิง"
          <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][12] == "หญิง") {echo "selected";}}?>
                 >หญิง</option>
                </select>
            </div>
            ...
            <div class="col-sm-3">
                <select class="form-control input-lg" name="lbReli" required="">
                  <option value="">-- กรุณาเลือก --</option>
                  <option value="พุทธ"
  <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][13] == "พุทธ") {echo "selected";}}?>
                  >พุทธ</option>
                  <option value="อิสลาม"
...
<?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][15] == "สิงคโปร์") {echo "selected";}}?>                  >สิงคโปร์</option>
  ...
  <?php if (isset($_SESSION["EDITE"])) {if ($_SESSION["EDITE"][16] == "NO") {echo "selected";}}?>
   ...
   <?php if (isset($_SESSION['SAS1'])) {
    if ($_SESSION['SAS1'][1] == "4") {?>
     ...
     <p>
                                <span class="glyphicon glyphicon-share"></span>
       2.1 สำหรับนักเรียนที่จบ ม.3 โรงเรียนธาตุนารายณ์วิทยาเท่านั้น
</h3>
<div class="alert alert-danger text-center" role="alert">
		<i><span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span> ส่วนนี้เฉพาะนักเรียนศิษย์เก่า ที่จบ ม.3 โรงเรียนธาตุนารายณ์วิทยา ถ้าไม่ใช่โปรดข้ามส่วนนี้</i>
    </div>



<div class="form-group form-group-lg ">
            <label class=" col-sm-3 control-label" for="formGroupInputLarge"> กรอกรหัสนักเรียนเดิม </label>
            <div class="col-sm-7">

                 <input name="txtstuIDold" class="form-control input-lg" id="txtstuIDold" OnKeyPress="return chkNumber(this)"
                    maxlength="5"
                    placeholder="กรอกรหัสนักเรียนเดิมตอน ม.ต้น" type="text"
                    value="<?php if (isset($_SESSION["EDITE"])) {echo $_SESSION["EDITE"][56];}?>"
                    >
            </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-8 col-sm-4 text-center">
                <button class="btn btn-info btn-lg btn-block" name="btnNext2"
      ...
      <?php } else {?>
        <div class="form-group">
            <div class="col-sm-offset-8 col-sm-4 text-center">
                <button class="btn btn-success btn-lg btn-block" name="btnEdite2"
                type="submit" value="Login"
                onclick="if(confirm('ยืนยันการแก้ไขส่วนที่2')) return true; else return false;"
                >
                    แก้ไขส่วนที่ 2   <span class="glyphicon glyphicon-check" aria-hidden="true"></span>
                </button>
            </div>
        </div>
  <?php }?>
