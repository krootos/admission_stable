        ...
        <div class="alert alert-success text-left" role="alert">
            <p>
                <span class="glyphicon glyphicon-indent-left" aria-hidden="true"></span> 
                    นักเรียนในเขตพื้นที่บริการ คือ นักเรียนที่มีรายชื่อในทะเบียนบ้าน ที่อยู่ในเขตเขตพื้นที่บริการโรงเรียนธาตุนารายณ์วิทยา ได้แก่ ตำบล &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ธาตุเชิงชุม 
                    ธาตุนาเวง พังขว้าง ฮางโฮง เชียงเครือ ก่อนวันที่ 16 พฤษภาคม 2561
            </p>
            <p>
                <span class="glyphicon glyphicon-indent-right" aria-hidden="true"></span> 
                    นักเรียนนอกเขต คือ นักเรียนที่มีรายชื่อในทะเบียนบ้าน ไม่อยู่ในเขตพื้นที่บริการฯ
            </p>
            <p> 
                    หรือ นักเรียนที่มีรายชื่อในทะเบียนบ้าน ที่อยู่ในเขตพื้นที่บริการฯ หลังวันที่ 16 พฤษภาคม 2561
            </p>            
        </div>
    ...
    <?php   if (!isset($_GET["edite"])) {?>
            ...
            if (isset($_SESSION['SAS1'])) {
                ...
                <?php if (isset($_SESSION["EDITE"]) && $_SESSION["EDITE"][2] == "นักเรียนในเขตพื้นที่บริการ") {echo "checked";}?>>
                            ...
                            <h5>
                                <label>
                                 นักเรียนในเขตพื้นที่บริการ คือ นักเรียนต้องมีชื่อในทะเบียนบ้าน ในเขตพื้นที่บริการ 5 ตำบล <br>ไม่ต่ำกว่า 2 ปี คือ (เข้ามาอยู่ก่อนวันที่ 16 พ.ค. 61) ได้แก่ 
                        ...
                        >
                            <h4><label >
                                <input type="radio" name="raOption" id="option1" value="นักเรียนนอกเขตพื้นที่บริการ"



                                    onclick="javascript:chickCheckbox();" required=""
                                    <?php 
                                        if (isset($_SESSION["EDITE"]) && $_SESSION["EDITE"][2] == "นักเรียนนอกเขตพื้นที่บริการ") {echo "checked";} 
            ...
            <?php if (isset($_SESSION["EDITE"]) && $_SESSION["EDITE"][2] == "นักเรียนในเขตพื้นที่บริการ") {echo "checked";}?>>
                            ...
                            <h5>
                                <label>
                                ( นักเรียนในเขตพื้นที่บริการ คือ นักเรียนต้องมีชื่อในทะเบียนบ้านในเขตพื้นที่บริการของโรงเรียน 5 ตำบล ได้แก่ ธาตุเชิงชุม ธาตุนาเวง พังขว้าง ฮางโฮง เชียงเครือ  ไม่ต่ำกว่า 2 ปี คือเข้ามาอยู่ก่อนวันที่ 16 พ.ค. 2561)
                                </label>
                            </h5>
                        </div>
                    ...
                    <div class="radio" 
                           <?php if(isset($_SESSION["EDITE"]) && $_SESSION["EDITE"][2] == ""){
                    ...
                    >
                            <h4>
                                <label>
                                    <input type="radio" name="raOption" id="option3"  value="นักเรียนนอกเขตพื้นที่บริการ"
                                    onclick="javascript:chickCheckbox();"
            <?php if (isset($_SESSION["EDITE"]) && $_SESSION["EDITE"][2] == "นักเรียนนอกเขตพื้นที่บริการ") {echo "checked";}?>>
